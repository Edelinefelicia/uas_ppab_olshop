 ...
 * Use the [BesiGuestFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class BesiGuestFragment : Fragment() {
    // TODO: Rename and change types of parameters
    private var param1: String? = null
    private var param2: String? = null
    private var _binding: FragmentBesiGuestBinding? =null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentBesiGuestBinding.inflate(inflater, container, false)
        return binding.root
    }
...
////                            productList.add(data)
    ...
    companion object {
         ...
         * @return A new instance of fragment BesiGuestFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            BesiGuestFragment().apply {
