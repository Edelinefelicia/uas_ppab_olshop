...
import com.example.uasolshop.databinding.FragmentSemenGuestBinding
...
private var _binding: FragmentSemenGuestBinding? =null
 ...
 * Use the [SemenGuestFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class SemenGuestFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        _binding = FragmentSemenGuestBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    private fun fetchProducts(binding: FragmentSemenGuestBinding) {
        val productList = ArrayList<Products>() // Gunakan ArrayList
            ...
            override fun onResponse(
                ...
                if (response.isSuccessful) {
                    ...
                    if (!products.isNullOrEmpty()) {
                        val filteredProducts = products.filter { it.kategori == "Semen" }
...
////                            productList.add(data)
                        Log.d("api ini semen", "body:{$productList}")
...
//                        adapterRetrofit.updateData(filteredProducts)
    ...
    companion object {
         ...
         * @return A new instance of fragment SemenGuestFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            SemenGuestFragment().apply {
