 ...
 * Use the [SemenFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class SemenFragment(parentFragment: FragmentManager) : Fragment() {
    // TODO: Rename and change types of parameters
    private var param1: String? = null
    private var param2: String? = null
    private var _binding: FragmentSemenBinding? =null
...
//    private lateinit var productAdapter: ProductAdapter
    ...
    override fun onCreateView(
        ...
        _binding = FragmentSemenBinding.inflate(inflater, container, false)
        return binding.root
    }
...
//        }
    ...
    private fun fetchProducts(binding: FragmentSemenBinding) {
...
//                        }
                        if (response.isSuccessful) {
                            ...
                            if (!products.isNullOrEmpty()) {
                                ...
                                Log.d("list semen", "body : ${productList}")
