 ...
 * Use the [BesiFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class BesiFragment(parentFragment: FragmentManager) : Fragment() {
    // TODO: Rename and change types of parameters
    private var param1: String? = null
    private var param2: String? = null
    private var _binding: FragmentBesiBinding? =null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentBesiBinding.inflate(inflater, container, false)
        return binding.root
    }
...
//        }
    ...
    private fun fetchProducts(binding: FragmentBesiBinding) {
...
//                        }
                        if (response.isSuccessful) {
                            ...
                            if (!products.isNullOrEmpty()) {
                                ...
                                Log.d("list besi", "body : ${productList}")
